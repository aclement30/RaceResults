import type { EventSummary, SerieSummary } from '../../../src/types/results'
import _ from 'lodash'

export const transformCategory = (catName: string, eventSummary: EventSummary | SerieSummary): string => {
