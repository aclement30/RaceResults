...
export const UpgradePointsTable: React.FC<ResultsTableProps> = ({
  ...
  const handleSelectDiscipline = (discipline: 'ROAD' | 'CX') => {
    ...
    window.umami?.track('select-athlete-upgrade-points-point-discipline', { discipline })
  ...
  const handleSelectPointType = (pointType: 'ALL' | 'UPGRADE' | 'SUBJECTIVE') => {
    ...
    window.umami?.track('select-athlete-upgrade-points-point-type', { pointType })
    setSearchParams(updatedParams)
  }
    ...
    <div style={{ width: '100%', marginTop: '1rem' }}>
      <Group style={{ paddingBottom: '1rem' }} justify="space-between">
        ...
        <Button
          ...
          data-umami-event="download-athlete-upgrade-points-csv"
          loading={loadingCsv}
          visibleFrom="sm"
