import type { RaceEvent } from '../../../src/types/results.ts'
...
export const getIgnoredCategories = (event: Pick<RaceEvent, 'serie'>): string[] => {
...
export const transformCategory = (
  catName: string,
  eventSummary: Pick<RaceEvent, 'hash' | 'serie'>
): string => {
